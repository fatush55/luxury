...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Filter Group</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= ADMIN ?>">Home</a></li>
                        <li class="breadcrumb-item active">Filter Group</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body table-relative p-0">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <td><?= $group->title ?></td>
                                    <td>
                                        <a href="<?= ADMIN ?>/filter/group-edit?id=<?=  $group->id ?>">
                                            <i class="fas fa-pencil-alt"></i>
                                        </a>
                                    </td>
                                    <td>
                                        <a class="delete text-danger" href="<?= ADMIN ?>/filter/group-delete?id=<?=  $group->id ?>">
