...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">User Search: "<?= h($query) ?>"</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= ADMIN ?>">Home</a></li>
                        <li class="breadcrumb-item"><a href="<?= ADMIN ?>/user">Users</a></li>
                        <li class="breadcrumb-item active">User Search: "<?= h($query) ?>"</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col col-md-12">
                            ...
                            <table class="table table-hover">
                                ...
                                <?php foreach ($users as $user): ?>
                                    <tr>
                                        ...
                                        <td class="hide_full"><?= $user->role ?></td>
                                        <td>
                    ...
                    <div class="float-right" style="margin: 35px">
                        <h6>(<?= count($users) ?> orders from <?= $count ?>)</h6>
